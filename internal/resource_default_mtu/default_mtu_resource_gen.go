...
func (t SpecType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	layer2SubinterfaceMtuAttribute, ok := attributes["layer2_subinterface_mtu"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`layer2_subinterface_mtu is missing from object`)

		return nil, diags
	}

	layer2SubinterfaceMtuVal, ok := layer2SubinterfaceMtuAttribute.(basetypes.Int64Value)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`layer2_subinterface_mtu expected to be basetypes.Int64Value, was: %T`, layer2SubinterfaceMtuAttribute))
	}
	...
	return SpecValue{
		...
		Layer2SubinterfaceMtu: layer2SubinterfaceMtuVal,
...
type SpecValue struct {
	...
	Layer2SubinterfaceMtu basetypes.Int64Value `tfsdk:"layer2_subinterface_mtu"`
...
func (v SpecValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["layer2_subinterface_mtu"] = basetypes.Int64Type{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.Layer2SubinterfaceMtu.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["layer2_subinterface_mtu"] = val
...
func (v SpecValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	if diags.HasError() {
		return types.ObjectUnknown(map[string]attr.Type{
			...
			"layer2_subinterface_mtu": basetypes.Int64Type{},
	...
	objVal, diags := types.ObjectValue(
		...
		map[string]attr.Value{
			...
			"layer2_subinterface_mtu": v.Layer2SubinterfaceMtu,
...
func (v SpecValue) Equal(o attr.Value) bool {
	...
	if !v.Layer2SubinterfaceMtu.Equal(other.Layer2SubinterfaceMtu) {
		return false
	}
