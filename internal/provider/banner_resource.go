...
const (
	create_rs_banner = "/apps/siteinfo.eda.nokia.com/v1/namespaces/{namespace}/banners"
	read_rs_banner   = "/apps/siteinfo.eda.nokia.com/v1/namespaces/{namespace}/banners/{name}"
	update_rs_banner = "/apps/siteinfo.eda.nokia.com/v1/namespaces/{namespace}/banners/{name}"
	delete_rs_banner = "/apps/siteinfo.eda.nokia.com/v1/namespaces/{namespace}/banners/{name}"
)
