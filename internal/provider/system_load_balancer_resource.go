...
const (
	create_rs_systemLoadBalancer = "/apps/siteinfo.eda.nokia.com/v1/namespaces/{namespace}/systemloadbalancers"
	read_rs_systemLoadBalancer   = "/apps/siteinfo.eda.nokia.com/v1/namespaces/{namespace}/systemloadbalancers/{name}"
	update_rs_systemLoadBalancer = "/apps/siteinfo.eda.nokia.com/v1/namespaces/{namespace}/systemloadbalancers/{name}"
	delete_rs_systemLoadBalancer = "/apps/siteinfo.eda.nokia.com/v1/namespaces/{namespace}/systemloadbalancers/{name}"
)
